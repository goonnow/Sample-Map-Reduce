...
# Test data
data = [
    "books/bc/tanselCGSS93/Tuzhilin93:::Alberto Pettorossi:::Bernhard Zeller:::Applications of temporal Databases to Knowledge-based Simulations map.",
    "books/bc/tanselCGSS93/Tuzhilin93:::Alberto Pettorossi:::Applications of temporal Databases to Knowledge-based simulation Simulation map-reduce."
]
...
s.datasource = dict(enumerate(getData()))
s.mapfn = mapfn
s.reducefn = reducefn
